...
class TestMicrocontroller:   
    ...
    def test_ADCPin(self):
        ...
        invalid_pin             = 6
        pairs                   = [(0,1), (2,3)]    # GPIO-Paare, welche verbunden sind (testen sich gegenseitig)
        ANALOG_HIGH_THRESHOLD   = 1023 - 50         # Toleranz, in der der ADC-Wert f�r HIGH / LOW liegen muss
        ...
        # Teste Existierenden Pin, jedoch ohne ADC Funktionalit�t (Pin 4 = PWMPin, kein ADCPin)
